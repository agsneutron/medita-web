        ...
        <v-card class="invisible-scrollbar">
            <v-card-title class="d-flex justify-content-center bg-purple py-5">
                ...
                <div class="d-flex text-white text-center py-0 mb-0">
                    ...
                    <div class="mx-2">Editar políticas de privacidad</div>
                </div>
            </v-card-title>
            <v-card-text>
                    ...
                    <v-container class="px-3rem">
                        <v-row justify="center">
                            <v-col cols="12" class="py-0">
                                <p class="text-violet my-2"><b>Políticas de privacidad</b></p>
    ...
    methods: {
        ...
        submit() {
            ...
            if (valid && this.content !== ''){
                this.isLoading = true;
                axios.post(route('admin.settings_privacy.upsert'), this.formData()).then(response =>{
